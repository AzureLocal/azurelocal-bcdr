# azurelocal-bcdr — Claude Code Context
...
- `azurelocal-bcdr-engineer` (model: sonnet) — Expert in `azurelocal-bcdr`: deep knowledge of this repo's structure, conventions, and development workflow.
